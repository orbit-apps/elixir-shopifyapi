defmodule ShopifyApi.Legacy.Webhook do
  @moduledoc """
  """
  alias ShopifyApi.AuthToken
  alias ShopifyApi.Legacy.{Request, Webhook}
  ...
  iex> ShopifyApi.Legacy.Webhook.webhook_uri(%AuthToken{app_name: "some-shopify-app"})
  ...
  iex> ShopifyApi.Legacy.Webhook.all(auth)
  ...
  iex> ShopifyApi.Legacy.Webhook.delete(auth, webhook_id)
  {:ok, %{}}
  """
  ...
  iex> ShopifyApi.Legacy.Webhook.create(auth, %{webhook: %{address: "https://example.com"}})
